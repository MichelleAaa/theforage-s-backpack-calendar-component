...
const App = () => {
  ...
  const [ dateSelect, setDateSelect ] = useState({selectionConfiguration:{ type: CALENDAR_SELECTION_TYPE.single, date: null }});

  const handleDateSelect = (date) => { 
    setDateSelect( {selectionConfiguration: {
        type: dateSelect.selectionConfiguration.type,
        date: date,
    }});
  };
    ...
    <main className={getClassName('App__main')}>
      ...
      <div>
        <BpkInput
          ...
          name="date"
          value={(dateSelect.selectionConfiguration.date || '').toString()}
        ...
        <BpkCalendar
          ...
          selectionConfiguration={dateSelect.selectionConfiguration}
        />
      </div>
